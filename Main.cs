...
namespace AviFavsPlus
{
    public static class BuildInfo
    {
        ...
        public const string Author = "404#0004 and fixed By PureFoxCore#5212"; // Author of the Mod.  (Set as null if none)
        ...
        public override void VRChat_OnUiManagerInit()
        {
            if (Config.CFG.Custom)
            {
                ...
                t.SetAction(() =>
                {
                    ...
                    APIUser.FetchUser(CustomList.AList.field_Public_SimpleAvatarPedestal_0.field_Internal_ApiAvatar_0.authorId, new Action<APIUser>(x =>
                    {
